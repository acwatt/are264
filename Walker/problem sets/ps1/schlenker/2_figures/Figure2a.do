...
local c = 1;
forvalues t = 1/4 {;
	matrix impact[`=`t'+8',1] = impactDummy`t'[1];
	centile impactDummy`t' if (_n > 1), centile(2.5 97.5);
	matrix lb[`=`t'+8',1] = r(c_1);
	matrix ub[`=`t'+8',1] = r(c_2);

	matrix impact[`=`t'+8',2] = impactCheby`t'[1];
	centile impactCheby`t' if (_n > 1), centile(2.5 97.5);
	matrix lb[`=`t'+8',2] = r(c_1);
	matrix ub[`=`t'+8',2] = r(c_2);

	matrix impact[`=`t'+8',3] = impactLin`t'[1];
	centile impactLin`t' if (_n > 1), centile(2.5 97.5);
	matrix lb[`=`t'+8',3] = r(c_1);
	matrix ub[`=`t'+8',3] = r(c_2);
};
...
twoway	(rcap lb ub x if (m==1), color(blue))
		...
		text(`xLine0'  1 "+1C", placement(s) color(black) size(medium))
		text(`xLine0'  2 "+2C", placement(s) color(black) size(medium))
		text(`xLine0'  3 "+3C", placement(s) color(black) size(medium))
		text(`xLine0'  4 "+4C", placement(s) color(black) size(medium))
		text(`xLine0'  6 "+1C", placement(s) color(black) size(medium))
		text(`xLine0'  7 "+2C", placement(s) color(black) size(medium))
		text(`xLine0'  8 "+3C", placement(s) color(black) size(medium))
		text(`xLine0'  9 "+4C", placement(s) color(black) size(medium))
		text(`xLine0' 11 "+1C", placement(s) color(black) size(medium))
		text(`xLine0' 12 "+2C", placement(s) color(black) size(medium))
		text(`xLine0' 13 "+3C", placement(s) color(black) size(medium))
		text(`xLine0' 14 "+4C", placement(s) color(black) size(medium))
